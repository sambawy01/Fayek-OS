/**
 * INERT BOOKING STUB — Fayek OS is a pure e-commerce (products) store with no
...
const DISABLED = "Booking is disabled — Fayek OS is an e-commerce store with no appointments.";
