/**
 * Photo / vision understanding for Fayek.
 *
 ...
 *
 * CRITICAL GUARDRAIL — NO SKIN / FACE ASSESSMENT. Fayek must REFUSE to
...
- "product": a retail PRODUCT (a jar, bottle, box, package or item) the owner wants to add to the shop.
